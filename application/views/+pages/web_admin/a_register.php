  ...
  <br><br>
	...
	<?php
        ...
        echo form_open('Web_Admin_ctr', $formattributes);
    ?>
        ...
        <button type="submit" name="register" class="waves-effect waves-light btn blue darken-3" onclick="validateForm()" >
            <i class="material-icons right">done</i>
            Register
        </button>
        <a href="<?php echo base_url()?>index.php/Web_Admin_ctr">Already have an account?</a>
        </br></br></br>
    </form>
	</div>
        </br></br></br></br>
