...
<!--                     <div class="input-field">
                        ...
                        <input id="fname" name="fname" type="text" class="validate" error="fname" maxlength="12" length="12" name="username" size="50">
                        <label for="fname" data-error="Error bruh">First Name</label>
                    </div> -->
					<?php 
